...
public class Log
{
	...
	public static void LogServ(Integer log_id, Integer etc_num1, Integer etc_num2, Integer etc_num3, Integer etc_num4)
	{
		...
		SqlLog(null, null, log_id, null, "", "", "", etc_num1, etc_num2, etc_num3, etc_num4, 0, 0, 0, 0, 0, 0);
	...
	public static void LogBug(L2Character activeObject, Integer log_id, String etc_str1, String etc_str2, String etc_str3, Integer etc_num1, Integer etc_num2)
	{
		...
		SqlLog(activeObject, null, log_id, null, etc_str1, etc_str2, etc_str3, etc_num1, etc_num2, 0, 0, 0, 0, 0, 0, 0, 0);
	}
	...
	public static void LogItem(L2Character activeObject, L2Character target, Integer log_id, L2ItemInstance Item, Long count)
	{
		...
		SqlLog(activeObject, target, log_id, Item, "", "", "", 0, 0, 0, 0, 0, 0, Item.getEnchantLevel(), Item.getItemId(), count.intValue(), Item.getIntegerLimitedCount());
	}
	...
	public static void LogChar(L2Character activeObject, Integer log_id, String etc_str3)
	{
		if(activeObject.getTarget() != null && activeObject.getTarget().isCharacter())
			SqlLogWithCharInfo(activeObject, (L2Character) activeObject.getTarget(), log_id, null, etc_str3, 0, 0, 0, 0, 0, 0);
		else
			SqlLogWithCharInfo(activeObject, null, log_id, null, etc_str3, 0, 0, 0, 0, 0, 0);
	}

	public static void SqlLogWithCharInfo(L2Character activeObject, L2Character target, Integer log_id, L2ItemInstance Item, String etc_str3, Integer etc_num5, Integer etc_num6, Integer etc_num7, Integer etc_num8, Integer etc_num9, Integer etc_num10)
	{
