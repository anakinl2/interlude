...
public final class PlayFail extends L2LoginServerPacket
{
	...
	public static final int REASON_MIN_AGE = 10; // Lineage II game service may used by individuals 15 years of age or older except for PvP server, which may only be used by adults 18 years of age and
	// older. (Korea Only)
