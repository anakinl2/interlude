...
public class EffectList
{
	...
	public L2Effect getEffectByType(final L2Effect.EffectType et)
	{
		if(_effects != null)
			for(final L2Effect e : _effects)
	...
	public L2Effect getEffectByIndexAndType(final int skill_id, final L2Effect.EffectType type)
	{
		if(_effects == null)
			return null;
		for(final L2Effect e : _effects)
	...
	public synchronized void addEffect(final L2Effect newEffect)
	{
		...
		if(owner.isEffectImmune() && newEffect.getEffectType() != L2Effect.EffectType.BuffImmunity)
		{
			final L2Skill.SkillType st = newEffect.getSkill().getSkillType();
			if(st == L2Skill.SkillType.BUFF || st == L2Skill.SkillType.DEBUFF)
				return;
		}
	...
	public void stopEffects(final L2Effect.EffectType type)
	{
		if(_effects != null)
			for(final L2Effect e : _effects)
