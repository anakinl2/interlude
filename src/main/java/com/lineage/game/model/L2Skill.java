...
import com.lineage.game.skills.skillclasses.AIeffects;
import com.lineage.game.skills.skillclasses.Aggression;
import com.lineage.game.skills.skillclasses.Balance;
import com.lineage.game.skills.skillclasses.BeastFeed;
import com.lineage.game.skills.skillclasses.BuffCharger;
import com.lineage.game.skills.skillclasses.CPDam;
import com.lineage.game.skills.skillclasses.Call;
import com.lineage.game.skills.skillclasses.Cancel;
import com.lineage.game.skills.skillclasses.Charge;
import com.lineage.game.skills.skillclasses.ChargeSoul;
import com.lineage.game.skills.skillclasses.ClanGate;
import com.lineage.game.skills.skillclasses.CombatPointHeal;
import com.lineage.game.skills.skillclasses.Continuous;
import com.lineage.game.skills.skillclasses.Craft;
import com.lineage.game.skills.skillclasses.DeathPenalty;
import com.lineage.game.skills.skillclasses.Default;
import com.lineage.game.skills.skillclasses.DeleteHate;
import com.lineage.game.skills.skillclasses.DeleteHateOfMe;
import com.lineage.game.skills.skillclasses.DestroySummon;
import com.lineage.game.skills.skillclasses.Disablers;
import com.lineage.game.skills.skillclasses.Drain;
import com.lineage.game.skills.skillclasses.DrainSoul;
import com.lineage.game.skills.skillclasses.Effect;
import com.lineage.game.skills.skillclasses.EffectsFromSkills;
import com.lineage.game.skills.skillclasses.FatalBlow;
import com.lineage.game.skills.skillclasses.Fishing;
import com.lineage.game.skills.skillclasses.Harvesting;
import com.lineage.game.skills.skillclasses.Heal;
import com.lineage.game.skills.skillclasses.HealPercent;
import com.lineage.game.skills.skillclasses.ItemHeal;
import com.lineage.game.skills.skillclasses.L2SkillSeed;
import com.lineage.game.skills.skillclasses.LethalShot;
import com.lineage.game.skills.skillclasses.MDam;
import com.lineage.game.skills.skillclasses.ManaDam;
import com.lineage.game.skills.skillclasses.ManaHeal;
import com.lineage.game.skills.skillclasses.ManaHealPercent;
import com.lineage.game.skills.skillclasses.ManaPotion;
import com.lineage.game.skills.skillclasses.NegateEffects;
import com.lineage.game.skills.skillclasses.NegateStats;
import com.lineage.game.skills.skillclasses.PDam;
import com.lineage.game.skills.skillclasses.Recall;
import com.lineage.game.skills.skillclasses.ReelingPumping;
import com.lineage.game.skills.skillclasses.RemoveAgroPoints;
import com.lineage.game.skills.skillclasses.Resurrect;
import com.lineage.game.skills.skillclasses.Ride;
import com.lineage.game.skills.skillclasses.SPHeal;
import com.lineage.game.skills.skillclasses.ShiftAggression;
import com.lineage.game.skills.skillclasses.SiegeFlag;
import com.lineage.game.skills.skillclasses.Signet;
import com.lineage.game.skills.skillclasses.Sowing;
import com.lineage.game.skills.skillclasses.Spoil;
import com.lineage.game.skills.skillclasses.StealBuff;
import com.lineage.game.skills.skillclasses.Summon;
import com.lineage.game.skills.skillclasses.SummonItem;
import com.lineage.game.skills.skillclasses.Sweep;
import com.lineage.game.skills.skillclasses.Switch;
import com.lineage.game.skills.skillclasses.TakeCastle;
import com.lineage.game.skills.skillclasses.TeleportNpc;
import com.lineage.game.skills.skillclasses.Toggle;
import com.lineage.game.skills.skillclasses.Unlock;
			...
			if(target instanceof L2Playable)
			{
				...
				if(isOffensive())
				{
					...
					else
					{
						...
						if(activeChar.isInZone(L2Zone.ZoneType.Siege) && target.isInZone(L2Zone.ZoneType.Siege))
						{
