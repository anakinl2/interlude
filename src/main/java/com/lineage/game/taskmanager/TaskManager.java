...
import static com.lineage.game.taskmanager.TaskTypes.TYPE_FIXED_SHEDULED;
import static com.lineage.game.taskmanager.TaskTypes.TYPE_GLOBAL_TASK;
import static com.lineage.game.taskmanager.TaskTypes.TYPE_NONE;
import static com.lineage.game.taskmanager.TaskTypes.TYPE_SHEDULED;
import static com.lineage.game.taskmanager.TaskTypes.TYPE_SPECIAL;
import static com.lineage.game.taskmanager.TaskTypes.TYPE_STARTUP;
import static com.lineage.game.taskmanager.TaskTypes.TYPE_TIME;
...
import com.lineage.game.taskmanager.tasks.TaskOlympiadSave;
import com.lineage.game.taskmanager.tasks.TaskRaidStatus;
import com.lineage.game.taskmanager.tasks.TaskRecom;
...
import com.lineage.game.taskmanager.tasks.TaskUpdateWebStatus;
...
public final class TaskManager
{
	...
	{
		registerTask(new TaskUpdateWebStatus());
		registerTask(new TaskRaidStatus());
