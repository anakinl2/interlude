...
public class TopicBBSManager extends BaseBBSManager
{
	...
	private void ShowMemoNewTopics(Forum forum, L2Player activeChar)
	{
		...
		html.append("<td align=center FIXWIDTH=70><button value=\"&$140;\" action=\"Write Topic crea " + forum.getID() + " Title Content Title\" width=40 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\"></td>");
	...
	private void ShowMemoTopics(Forum forum, L2Player activeChar, int index)
	{
		...
		html.append("<td align=right><button value = \"&$421;\" action=\"bypass _bbstopics;crea;" + forum.getID() + "\" width=40 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\"></td></tr>");
		html.append("<tr><td><img src=\"l2ui.mini_logo\" width=5 height=10></td></tr>");
		html.append("<tr> ");
		html.append("<td></td>");
		html.append("<td align=center><table border=0><tr><td></td><td><edit var = \"Search\" width=130 height=11></td>");
		html.append("<td><button value=\"&$420;\" action=\"Write 5 -2 0 Search _ _\" back=\"L2UI_CT1.Button_DF_Small_Down\" width=40 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\"> </td> </tr></table> </td>");
		html.append("</tr>");
		html.append("</table>");
		html.append("<br>");
		html.append("<br>");
