...
import com.lineage.game.serverpackets.AskJoinParty;
...
public class RequestJoinParty extends L2GameClientPacket
{
	...
	private void addTargetToParty(L2GameClient client, int itemDistribution, L2Player target, L2Player activeChar)
	{
		...
		{
			activeChar.sendMessage(new CustomMessage("com.lineage.game.clientpackets.RequestJoinParty.InDimensionalRift", activeChar));
			activeChar.sendActionFailed();
		}
