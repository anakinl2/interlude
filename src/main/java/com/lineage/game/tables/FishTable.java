...
import com.lineage.game.model.FishDropData;
...
public class FishTable
{
	...
	public List<FishDropData> getFishReward(int fishid)
	{
	...
	public int GetRandomFishLvl(L2Player player)
	{
		...
		FastList<L2Effect> effect = player.getEffectList().getEffectsBySkillId(2274);
		if(effect != null)
			skilllvl = (int) effect.getFirst().getSkill().getPower();
		else
