...
public class CatacombSpawnManager
{
	...
	private static HashSet<L2Spawn> _dawnMobs = new HashSet<L2Spawn>();
	private static HashSet<L2Spawn> _duskMobs = new HashSet<L2Spawn>();
	...
	public void spawnMobs(HashSet<L2Spawn> mobsSpawnsList)
	{
	...
	public static void deleteMobs(HashSet<L2Spawn> mobsSpawnsList)
	{
		for(L2Spawn spawnDat : mobsSpawnsList)
			spawnDat.despawnAll();
	}
