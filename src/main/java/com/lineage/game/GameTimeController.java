...
import com.lineage.game.serverpackets.ClientSetTime;
...
public class GameTimeController
{
	...
	private GameTimeController()
	{
		...
		ThreadPoolManager.getInstance().scheduleGeneralAtFixedRate(new CheckSunState(), ((getGameTime() / 60 % 24 + 1) * 60 - getGameTime()) * 1000, 120000);
	}
