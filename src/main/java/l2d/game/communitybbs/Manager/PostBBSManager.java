...
import l2d.game.communitybbs.BB.Post;
import l2d.game.communitybbs.BB.Post.CPost;
import l2d.game.communitybbs.BB.Topic;
...
public class PostBBSManager extends BaseBBSManager
{
	...
	private void ShowHtmlEditPost(Topic topic, L2Player activeChar, Forum forum, Post p)
	{
		...
		html.append("<td align=center FIXWIDTH=70><button value=\"&$140;\" action=\"Write Post " + forum.getID() + ";" + topic.getID() + ";0 _ Content Content Content\" width=40 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\"></td>");
		html.append("<td align=center FIXWIDTH=70><button value = \"&$141;\" action=\"bypass _bbsmemo\" width=40 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\"> </td>");
	...
	private void ShowMemoPost(Topic topic, L2Player activeChar, Forum forum)
	{
		...
		html.append("<button value=\"&$422;\" action=\"bypass _bbsmemo\" width=40 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\">");
		html.append("</td>");
		html.append("<td width=560 align=right><table border=0 cellspacing=0><tr>");
		html.append("<td FIXWIDTH=300></td><td><button value = \"&$424;\" action=\"bypass _bbsposts;edit;" + forum.getID() + ";" + topic.getID() + ";0\" width=40 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\"></td>&nbsp;");
		html.append("<td><button value = \"&$425;\" action=\"bypass _bbstopics;del;" + forum.getID() + ";" + topic.getID() + "\" width=40 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\"></td>&nbsp;");
		html.append("<td><button value = \"&$421;\" action=\"bypass _bbstopics;crea;" + forum.getID() + "\" width=40 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\"></td>&nbsp;");
		html.append("</tr></table>");
		html.append("</td>");
		html.append("</tr>");
		html.append("</table>");
