...
public class ConditionElementSeed extends Condition
{
	...
	public boolean testImpl(Env env)
	{
		...
		{
			EffectSeed currenteffect = (EffectSeed) env.character.getEffectList().getEffectBySkillId(seedSkills[i]);

			Seeds[i] = currenteffect instanceof EffectSeed ? currenteffect.getPower() : 0;
