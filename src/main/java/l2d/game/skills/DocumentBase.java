...
import l2d.game.skills.conditions.ConditionElementSeed;
import l2d.game.skills.conditions.ConditionForceBuff;
import l2d.game.skills.conditions.ConditionGameTime;
import l2d.game.skills.conditions.ConditionGameTime.CheckGameTime;
import l2d.game.skills.conditions.ConditionHasSkill;
import l2d.game.skills.conditions.ConditionInstanceOf;
import l2d.game.skills.conditions.ConditionLogicAnd;
import l2d.game.skills.conditions.ConditionLogicNot;
import l2d.game.skills.conditions.ConditionLogicOr;
import l2d.game.skills.conditions.ConditionPlayerInvSize;
import l2d.game.skills.conditions.ConditionPlayerMaxLevel;
import l2d.game.skills.conditions.ConditionPlayerMaxPK;
import l2d.game.skills.conditions.ConditionPlayerMaxPercentCp;
import l2d.game.skills.conditions.ConditionPlayerMinHp;
import l2d.game.skills.conditions.ConditionPlayerMinLevel;
import l2d.game.skills.conditions.ConditionPlayerMinPercentCp;
import l2d.game.skills.conditions.ConditionPlayerPercentCp;
import l2d.game.skills.conditions.ConditionPlayerPercentHp;
import l2d.game.skills.conditions.ConditionPlayerPercentMp;
import l2d.game.skills.conditions.ConditionPlayerRace;
import l2d.game.skills.conditions.ConditionPlayerRiding;
import l2d.game.skills.conditions.ConditionPlayerRiding.CheckPlayerRiding;
...
import l2d.game.skills.conditions.ConditionPlayerWeight;
import l2d.game.skills.conditions.ConditionSlotItemId;
import l2d.game.skills.conditions.ConditionTargetAggro;
import l2d.game.skills.conditions.ConditionTargetCastleDoor;
import l2d.game.skills.conditions.ConditionTargetDirection;
import l2d.game.skills.conditions.ConditionTargetHasBuff;
import l2d.game.skills.conditions.ConditionTargetHasBuffId;
import l2d.game.skills.conditions.ConditionTargetMob;
import l2d.game.skills.conditions.ConditionTargetNpcId;
import l2d.game.skills.conditions.ConditionTargetPlayable;
import l2d.game.skills.conditions.ConditionTargetPlayerRace;
import l2d.game.skills.conditions.ConditionTargetRace;
import l2d.game.skills.conditions.ConditionUsingArmor;
import l2d.game.skills.conditions.ConditionUsingItemType;
import l2d.game.skills.conditions.ConditionUsingSkill;
import l2d.game.skills.conditions.ConditionZone;
