...
public class DecayTaskManager
{
	...
	{
		ThreadPoolManager.getInstance().scheduleGeneralAtFixedRate(new DecayScheduler(), 2000, 2000);
	}
	...
	{
		private WeakReference<L2Character> actor;
		public long endtime;

		DecayTask(L2Character cha, long delay)
		{
			actor = new WeakReference<L2Character>(cha);
			endtime = delay;
		}
