...
import static l2d.game.model.L2Zone.ZoneType.damage;
import static l2d.game.model.L2Zone.ZoneType.instant_skill;
import static l2d.game.model.L2Zone.ZoneType.no_landing;
import static l2d.game.model.L2Zone.ZoneType.no_restart;
import static l2d.game.model.L2Zone.ZoneType.peace_zone;
import static l2d.game.model.L2Zone.ZoneType.poison;
import static l2d.game.model.L2Zone.ZoneType.ssq_zone;
import static l2d.game.model.L2Zone.ZoneType.swamp;
...
import l2d.game.ai.L2PlayableAI;
import l2d.game.ai.L2PlayableAI.nextAction;
import l2d.game.ai.L2PlayerAI;
import l2d.game.cache.Msg;
import l2d.game.cache.PlayerShiftCache;
import l2d.game.clientpackets.EnterWorld;
import l2d.game.communitybbs.BB.Forum;
import l2d.game.communitybbs.Manager.ForumsBBSManager;
...
import l2d.game.loginservercon.gspackets.ChangeAccessLevel;
import l2d.game.model.BypassManager.BypassType;
import l2d.game.model.BypassManager.DecodedBypass;
import l2d.game.model.BypassManager.EncodedBypass;
...
import l2d.game.model.entity.olympiad.OlympiadGame;
...
import l2d.game.model.instances.L2GuardInstance;
...
import l2d.game.serverpackets.ConfirmDlg;
...
import l2d.game.serverpackets.DropItem;
...
import l2d.game.serverpackets.ExFishingEnd;
...
import l2d.game.serverpackets.ExOlympiadUserInfoSpectator;
import l2d.game.serverpackets.ExSetCompassZoneCode;
import l2d.game.serverpackets.ExStorageMaxCount;
import l2d.game.serverpackets.ExUseSharedGroupItem;
import l2d.game.serverpackets.GetItem;
import l2d.game.serverpackets.HennaInfo;
...
import l2d.game.serverpackets.NpcInfoPoly;
import l2d.game.serverpackets.ObserverEnd;
import l2d.game.serverpackets.ObserverStart;
import l2d.game.serverpackets.PartySmallWindowUpdate;
...
import l2d.game.serverpackets.PledgeShowMemberListDelete;
...
import l2d.game.serverpackets.PrivateStoreListBuy;
import l2d.game.serverpackets.PrivateStoreListSell;
...
import l2d.game.serverpackets.ShortCutInit;
...
import l2d.game.serverpackets.Snoop;
import l2d.game.serverpackets.SocialAction;
import l2d.game.serverpackets.SpawnEmitter;
import l2d.game.serverpackets.SpawnItem;
import l2d.game.serverpackets.SpawnItemPoly;
...
import l2d.game.serverpackets.TargetSelected;
import l2d.game.serverpackets.TargetUnselected;
...
import l2d.game.taskmanager.AutoSaveManager;
import l2d.game.taskmanager.BreakWarnManager;
import l2d.game.templates.L2Armor;
...
public final class L2Player extends L2Playable {
    ...
    private static L2Player restore(final int objectId) {
        ...
        try {
            ...
            if (pl_rset.next() && ps_rset.next()) {
                ...
                final L2Zone noRestartZone = ZoneManager.getInstance().getZoneByTypeAndObject(no_restart, player);
                ...
                if (!player.isGM() && player.isInZone(ZoneType.Siege)) {
     ...
     * {@link L2Player#broadcastPacketToOthers(l2d.game.serverpackets.L2GameServerPacket)} для рассылки CharInfo<BR><BR> <B><U> Действия</U> :</B><BR><BR> <li>Отсылка игроку UserInfo(личные и
     ...
     * {@link l2d.game.model.L2Player#sendChanges()}</B></FONT><BR><BR>
     */
    @Override
    ...
    void doZoneCheck(final int messageNumber) {
        ...
        setInSSZone(isInZoneIncludeZ(ssq_zone));
    ...
    class WaterTask implements Runnable {
        @Override
        public void run() {
            if (isDead() || !isInZoneIncludeZ(ZoneType.water)) {
