...
import l2d.game.serverpackets.PartySpelled;
import l2d.game.serverpackets.SystemMessage;
import l2d.game.skills.Env;
import l2d.game.skills.Stats;
import l2d.game.skills.effects.EffectAddSkills;
import l2d.game.skills.effects.EffectAntiSummon;
import l2d.game.skills.effects.EffectBetray;
import l2d.game.skills.effects.EffectBigHead;
import l2d.game.skills.effects.EffectBlessNoblesse;
import l2d.game.skills.effects.EffectBlockStat;
import l2d.game.skills.effects.EffectBluff;
import l2d.game.skills.effects.EffectBuff;
import l2d.game.skills.effects.EffectBuffImmunity;
import l2d.game.skills.effects.EffectCPDamPercent;
import l2d.game.skills.effects.EffectCancelEffect;
import l2d.game.skills.effects.EffectClanGate;
import l2d.game.skills.effects.EffectCombatPointHealOverTime;
import l2d.game.skills.effects.EffectConsumeSoulsOverTime;
import l2d.game.skills.effects.EffectCurseOfLifeFlow;
import l2d.game.skills.effects.EffectDamOverTime;
import l2d.game.skills.effects.EffectDamOverTimeLethal;
import l2d.game.skills.effects.EffectDestroySummon;
import l2d.game.skills.effects.EffectDiscord;
import l2d.game.skills.effects.EffectEnervation;
import l2d.game.skills.effects.EffectFakeDeath;
import l2d.game.skills.effects.EffectFear;
import l2d.game.skills.effects.EffectForce;
import l2d.game.skills.effects.EffectGrow;
import l2d.game.skills.effects.EffectHeal;
import l2d.game.skills.effects.EffectHealBlock;
import l2d.game.skills.effects.EffectHealCPPercent;
import l2d.game.skills.effects.EffectHealOverTime;
import l2d.game.skills.effects.EffectHealPercent;
import l2d.game.skills.effects.EffectImobileBuff;
import l2d.game.skills.effects.EffectInterrupt;
import l2d.game.skills.effects.EffectInvisible;
import l2d.game.skills.effects.EffectInvulnerable;
import l2d.game.skills.effects.EffectLDManaDamOverTime;
import l2d.game.skills.effects.EffectManaDamOverTime;
import l2d.game.skills.effects.EffectManaHeal;
import l2d.game.skills.effects.EffectManaHealOverTime;
import l2d.game.skills.effects.EffectManaHealPercent;
import l2d.game.skills.effects.EffectMeditation;
import l2d.game.skills.effects.EffectMute;
import l2d.game.skills.effects.EffectMuteAll;
import l2d.game.skills.effects.EffectMuteAttack;
import l2d.game.skills.effects.EffectMutePhisycal;
import l2d.game.skills.effects.EffectParalyze;
import l2d.game.skills.effects.EffectPetrification;
import l2d.game.skills.effects.EffectRecoverForce;
import l2d.game.skills.effects.EffectRelax;
import l2d.game.skills.effects.EffectRoot;
import l2d.game.skills.effects.EffectSalvation;
import l2d.game.skills.effects.EffectSeed;
import l2d.game.skills.effects.EffectSignet;
import l2d.game.skills.effects.EffectSilentMove;
import l2d.game.skills.effects.EffectSleep;
import l2d.game.skills.effects.EffectStun;
import l2d.game.skills.effects.EffectTemplate;
import l2d.game.skills.effects.EffectTrigger;
import l2d.game.skills.effects.EffectTurner;
import l2d.game.skills.effects.EffectUltimateDefense;
...
public abstract class L2Effect implements Comparable
{
	...
	public L2Effect(final Env env, final EffectTemplate template)
	{
		...
		if(_skill.getSkillType() == SkillType.BUFF && _period > 30000 && _skill.getId() != 396 && _skill.getId() != 1374)
		{
		...
		if(_skill.getSkillType() == SkillType.MUSIC)
