...
public class L2Zone
{
	...
	private final FastList<L2Object> _objects = FastList.newInstance();
	private final HashMap<L2Character, ZoneSkillTimer> _skillTimers = new HashMap<L2Character, ZoneSkillTimer>();
	...
	public Location getSpawn()
	{
		...
		FastList<int[]> coords = _restartPoints.getCoords();
		int[] coord = coords.get(Rnd.get(coords.size()));
		return new Location(coord[0], coord[1], coord[2]);
	}

	public FastList<int[]> getSpawns()
	{
	...
	public Location getPKSpawn()
	{
		if(_PKrestartPoints == null)
			return getSpawn();
		FastList<int[]> coords = _PKrestartPoints.getCoords();
	...
	public void doEnter(L2Object object)
	{
		synchronized (_objects)
		{
			if(!_objects.contains(object))
				...
				_log.severe("Attempt of double object add to zone.");
		}
	...
	public void doLeave(L2Object object, boolean notify)
	{
		synchronized (_objects)
		{
			...
			if(!remove)
			{
				_log.severe("Attempt remove object from zone where it's absent");
				Thread.dumpStack();
			}
		}
	...
	public FastList<L2Object> getInsideObjectsIncludeZ()
	{
	...
	public FastList<L2Player> getInsidePlayers()
	{
		L2Object[] all_objects = getObjects();
	...
	public FastList<L2Player> getInsidePlayersIncludeZ()
	{
		L2Object[] all_objects = getObjects();
		FastList<L2Player> result = new FastList<L2Player>();
		for(L2Object obj : all_objects)
	...
	public void setUnitTick(String delay)
	{
		...
		_unitTick = Integer.parseInt(delay) * 1000;
	}
		...
		public void run()
		{
			...
			synchronized (_objects)
			{
				for(L2Object object : _objects)
				{
					...
					if(_target == null && !(object instanceof L2Playable)) // Если цель не указана, то валим только игроков
						continue;
