	...
	public void onBypassFeedback(L2Player player, String command)
	{
		...
		if(condition)
		{
			if(actualCommand.equalsIgnoreCase("RideWyvern") && player.isClanLeader())
				...
				else if(player.getInventory().getItemByItemId(1460) == null || player.getInventory().getItemByItemId(1460).getIntegerLimitedCount() < 25)
				{
					NpcHtmlMessage html = new NpcHtmlMessage(player, this);
				...
				{
					if(player.getInventory().destroyItemByItemId(1460, 25, false) == null)
