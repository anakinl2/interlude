...
public class FiveYearsLineage extends Functions implements ScriptFile
{
	...
	{
		return Helper.IsActive("FiveYearsLineage");
	}
	...
	public void startEvent()
	{
		...
		if(Helper.SetActive("FiveYearsLineage", true))
		{
			spawnEventManagers();
	...
	public void stopEvent()
	{
		...
		if( !player.getPlayerAccess().IsEventGm)
			return;
		if(Helper.SetActive("FiveYearsLineage", false))
		{
	...
	public static void OnDie(L2Character cha, L2Character killer)
	{
		if(_active && Helper.SimpleCheckDrop(cha, killer))
		{
			...
			if(Rnd.chance(letter[1] * Config.EVENT_FIVE_YEARS_LINEAGE_LETTER_CHANCE * ((L2NpcTemplate) cha.getTemplate()).rateHp))
