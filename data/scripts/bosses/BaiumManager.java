...
public class BaiumManager extends Functions implements ScriptFile
{
	...
	private static List<L2NpcInstance> _angels = new FastList<L2NpcInstance>();
	private static List<L2Spawn> _angelSpawns = new FastList<L2Spawn>();
	...
	private final static int FWB_FIXINTERVALOFBAIUM = 24 * 60 * 60000;
	...
	private static void init()
	{
		...
		try
		{
			...
			SpawnTable.getInstance().addNewSpawn(_teleportCubeSpawn, false);
		}
		catch(Exception e)
		{
			e.printStackTrace();
	...
	{
		// eliminate players.
		//FIXME:Player who dont have quest leave for pvp server ofc
		//banishForeigners();
	...
	public static void spawnBaium(L2NpcInstance NpcBaium, L2Player awake_by)
	{
		...
		// delete statue	
		_statueSpawn.despawnAll();
		if(_npcBaium.getSpawn()!=null)
		{
